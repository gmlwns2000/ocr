...
class googleimagesdownload:
    ...
    def create_directories(self,main_directory, dir_name,thumbnail):
        ...
        dir_name_thumbnail = self.safename(dir_name_thumbnail)
    ...
    def download_image_thumbnail(self,image_url,main_directory,dir_name,return_image_name,print_urls,socket_timeout,print_size,no_download):
        ...
        try:
            ...
            try:
                ...
                path = main_directory + "/" + dir_name + " - thumbnail" + "/" + self.safename(return_image_name)
    ...
    def download_image(self,image_url,image_format,main_directory,dir_name,count,print_urls,socket_timeout,prefix,print_size,no_numbering,no_download):
        ...
        try:
            ...
            try:
                ...
                image_name = self.safename(image_name)
                ...
                try:
                    ...
                    download_status = 'fail'
                    download_message += "ERR OSError on an image...trying next one..." + " Error: " + str(e)
                    return_image_name = ''
                    absolute_path = ''

                #return image name back to calling method to use it for thumbnail downloads
                download_status = 'success'
                download_message += "INFO Completed Image = " + absolute_path
                return_image_name = prefix + str(count) + "_" + image_name
        ...
        if download_status == 'fail':
            download_message = "ERR " + download_message
            ...
            for sky in suffix_keywords:     # 1.for every suffix keywords
                ...
                while i < len(search_keyword):      # 2.for every main keyword
                    ...
                    if arguments['related_images']:
                        print("INFO Getting list of related keywords...this may take a few moments")
                        ...
                        for key, value in tabs.items():
                            ...
                            self._get_all_items(new_raw_html, main_directory, self.safename(search_term + " - " + key), limit,arguments)

                    i += 1
                    print("\nErrors: " + str(errorCount) + "\n")
                    print("INFO Finish main keyword. -", "Search Term:", search_term, "Errors:", errorCount,)
